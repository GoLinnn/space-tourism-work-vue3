...
若将图片存放在public文件夹下，则不会经过打包，可以直接通过`/image-moon.png`解析图片路径（具体见最下方的Vite打包）
...
--public
----home
------background-page-home.jpg // 静态图片资源
--src
----views
------home.vue // 引入图片
----App.vue
...
将静态资源放入public文件夹，在home页面编写时**以public为根目录编写图片引用路径**

```css
/*home.vue*/
background: url('/home/background-page-home.jpg')
```
...
新增dist文件夹，所有在public的静态资源不被处理直接放入dist文件夹下，页面内的图片可以被正常引用

**使用vite多次打包可能会出现home.vue已更新，打包后的dist文件内未更新的问题，可以通过清理缓存解决🤔**

## Github Page更新慢！

于是我使用vercel了😊

[点击查看此项目哦](https://space-tourism-work-vue3.vercel.app/)
